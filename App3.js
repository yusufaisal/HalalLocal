...
import {Location, MapView, Permissions, MailComposer} from "expo";
                                ...
                                <View style={{marginTop: 20, justifyContent: 'center', alignItems: 'center'}}>
                                    <Text onPress={()=>{
                                        this._sendMailAsync();
                                          ...
                                          style={{color: '#13a89e', fontSize: 14, borderBottomColor: '#13a89e', borderBottomWidth: 1, paddingHorizontal: 10, paddingBottom: 3}}>{this.state.lg.menu.feedbacktext}</Text>
                                </View>
