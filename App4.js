...
export class App extends React.Component {
    static navigationOptions = {
        ...
        //     <View style={{flex: 1}}>
        //         <Image
        //             source={require('./img/header_title.jpg')}
        //             style={{
        //                 width: 120,
        //                 height: 50,
        //                 alignSelf: 'center',
        ...
        //         />
        //     </View>,
        // headerStyle: {backgroundColor: '#13a89e'},
        // headerRight: <Pickers/>
        header: null
    };
        ...
        const content = (<View style={{flexDirection:"column", width: 155}}>
            <View style={{alignItems: 'center',
                ...
                <Image style={{width: 153, height: 130, borderRadius: 5, resizeMode: item.photo != restodef ? 'cover' : 'contain'}}
                       source={item.photo != restodef ? {uri: item.photo} : require('./img/resto-b.jpg')} />
            </View>
    ...
    onRenderCarousel() {
        if (!this.state.isCarouselLoaded) {
            return(
                <View>
                    <Image
                        source={require('./img/slide_mobile_1.jpg')}
                        style = {{
                            width: width,
                            height: 200,
                            resizeMode: 'cover',
    ...
    getIntro() {
        return <AppIntro
            ...
            onDoneBtnClick={()=>{this.setState({intro: false}, this.forceUpdate())}}
                        ...
                        <View style={{paddingBottom: 10}}>
                            ...
                            <View style={styles.containerFeatures}>
                                    ...
                                    >
                                        <View style={styles.buttonFeature}>
                                            <Image style={{ width: 40, height: 40 }}
                                                   source={require('./img/resto-b.jpg')}/>
                                    ...
                                    >
                                        <View style={styles.buttonFeature}>
                                            <Image style={{ width: 40, height: 40 }}
                                                   source={require('./img/masjid-b.jpg')}/>
                            ...
                            <View style={styles.containerFeatures}>
                                    ...
                                    >
                                        <View style={styles.buttonFeature}>
                                            <Image style={{ width: 40, height: 40 }}
                                                   source={require('./img/informasi-b.jpg')}/>
                                    ...
                                    >
                                        <View style={styles.buttonFeature}>
                                            <Image style={{ width: 40, height: 40 }}
                                                   source={require('./img/jadwal-b.jpg')}/>
                                    ...
                                    >
                                        <View style={styles.buttonFeature}>
                                            <Image style={{ width: 40, height: 40 }}
                                                   source={require('./img/kiblat-b.jpg')}/>
                                    ...
                                    (<View style={{flex:1}}>
                                        ...
                                        >
                                            ...
                                            <MapView.Marker
                                                ...
                                                pinColor={this.state.mosque.type=="keyword"?"red":"orange"}
                                            >
                                            </MapView.Marker>
                                        </MapView>
                                        {Platform.OS !== 'android' ?
                ...
                {this.state.show ?
                    <View style={{position: 'absolute',
                        ...
                        <View style={{position: 'absolute',
                            ...
                            {Platform.OS !== 'android' ?
                            <TouchableNativeFeedback style={{flex:1}} onPress={()=>{this.setState({show: false})}}>
                                <View style={{
                                    flex: 1,
                                    alignItems: 'center',
                                    justifyContent: 'center'}}>
                            ...
                            <View style={{
                                ...
                                <View style={{width: "100%", backgroundColor: "white", opacity: 1, borderRadius: 10,
                                    ...
                                    <View style={{margin: 10}}>
                                        <TouchableNativeFeedback onPress={()=>{this.updateLang("en");}}>
                                            <View style={{flexDirection: 'row', marginVertical: 10, alignItems: 'center'}}>
                                                <Image source={require('./img/en.png')} style={{width: 24, height: 24, marginRight: 10, resizeMode: 'cover'}}/>
                                                <Text>English</Text>
                                            </View>
                                        </TouchableNativeFeedback>
                                        <View style={{borderWidth:0.5, borderColor: "lightgrey"}} />
                                        <TouchableNativeFeedback onPress={()=>{this.updateLang("id");}}>
                                            <View style={{flexDirection: 'row', marginVertical: 10, alignItems: 'center'}}>
                                                <Image source={require('./img/id.png')} style={{width: 24, height: 24, marginRight: 10, resizeMode: 'cover'}}/>
                                                <Text>Bahasa</Text>
                                            </View>
                                        </TouchableNativeFeedback>
                                        <View style={{borderWidth:0.5, borderColor: "lightgrey"}} />
                                        <TouchableNativeFeedback onPress={()=>{this.updateLang("ar");}}>
                                            <View style={{flexDirection: 'row', marginVertical: 10, alignItems: 'center'}}>
                                                <Image source={require('./img/ar.png')} style={{width: 24, height: 24, marginRight: 10, resizeMode: 'cover'}}/>
                                                <Text>العربية</Text>
                                            </View>
                                        </TouchableNativeFeedback>
                                        <View style={{borderWidth:0.5, borderColor: "lightgrey"}} />
                                        <TouchableNativeFeedback onPress={()=>{this.updateLang("cn");}}>
                                            <View style={{flexDirection: 'row', marginVertical: 10, alignItems: 'center'}}>
                                                <Image source={require('./img/cn.png')} style={{width: 24, height: 24, marginRight: 10, resizeMode: 'cover'}}/>
                                                <Text>中文</Text>
                                            </View>
                                        </TouchableNativeFeedback>
                                    </View> :
...
class Row extends React.PureComponent {
    render () {
        let content = <View style={styles.insideRestoBox}>
            <View style={{alignItems: 'center',
                justifyContent: 'center',
                overflow: 'hidden',
                ...
                <Image style={{width: 100, height: 80, borderRadius: 5, resizeMode: this.props.item.photo != restodef ? 'cover' : 'contain'}}
                       source={this.props.item.photo == restodef ? require('./img/resto-b.jpg') : {uri: this.props.item.photo}} />
            </View>
    ...
    render() {
        ...
        return(<Animated.View
            ...
            <Image style={{ width: 200, height: 200 }}
                   source={require('./img/compass-a.jpg')}/>
        </Animated.View>);
    }
}
                        ...
                        >
                            ...
                            {this.state.markers && this.state.markers.length>1 ? this.state.markers.map(marker => (
                                <MapView.Marker
                                    ...
                                    pinColor={marker.type=="keyword"?"red":"orange"}
                                >
                                </MapView.Marker>
                            )):<View/>}
                            ...
                            <View style={{
                                ...
                                <View style={{alignItems: 'center',
                                    ...
                                    <Image style={{width: 100, height: 80, borderRadius: 5, resizeMode: this.state.markers[this.state.show].photo != mosquedef ? 'cover' : 'contain'}}
                                           source={this.state.markers[this.state.show].photo == mosquedef ? require('./img/masjid-b.jpg') : {uri: this.state.markers[this.state.show].photo}} />
                                </View>
        ...
        headerRight:
            Platform.OS !== 'android' ?
                <TouchableNativeFeedback
                    ...
                    <View>
                        <Image
                            source={require('./img/map-resto.png')}
                            style={{
                                width: 24,
                                height: 24,
                                alignSelf: 'center',
                            ...
                            <View style={{
                                ...
                                <View style={{alignItems: 'center',
                                    ...
                                    <Image style={{width: 100, height: 80, borderRadius: 5, resizeMode: this.state.markers[this.state.show].photo != restodef ? 'cover' : 'contain'}}
                                           source={this.state.markers[this.state.show].photo == restodef ? require('./img/resto-b.jpg') : {uri: this.state.markers[this.state.show].photo}} />
                                </View>
                                <View style={{marginLeft: 10, flexDirection: 'column', flex: 1}}>
                                    <Text style={{fontWeight: "bold", fontSize: 14, color: "#686868"}}>{this.state.markers[this.state.show].text}</Text>
                                    <Text style={{fontSize: 12, color: "#909090"}}>{lg.list.distance+": ~"+Math.round(this.state.markers[this.state.show].distance/100)/10 + lg.list.km}</Text>
                                    <Text style={{fontSize: 12, color: "#909090"}}>{lg.list.source}: {this.state.markers[this.state.show].source}</Text>
                                    <Text style={{fontWeight: 'normal', fontSize:12, color: this.state.markers[this.state.show].open ? '#13a89e' : '#909090'}}>{this.state.markers[this.state.show].open ? this.state.lg.list.open : this.state.markers[this.state.show].open === false ? this.state.lg.list.closed : this.state.lg.list.open_na}</Text>
                                </View>
                                <View style={{justifyContent: 'space-around'}}>
                                    <View style={{flex:1, alignItems: 'flex-end', justifyContent: 'flex-start'}}>
                                        {Platform.OS !== 'android' ?
                                ...
                                <View>
                                    {
                                        (Platform.OS === 'android') ?
                                            <View style={{flexDirection: "row", width: '70%', alignSelf: 'flex-end', alignItems: 'center', justifyContent: 'center', backgroundColor:'white', paddingHorizontal: 10, borderRadius: 20}}>
                                                <Image source={require('./img/jadwal-b.jpg')} style={{width: 24, height: 24, marginHorizontal: 10, resizeMode: 'contain'}} />
                                                <Picker
